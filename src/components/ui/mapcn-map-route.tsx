...
function PopupCloseButton({ onClick }: { onClick: () => void }) {
  return (
    <button
      ...
      className="absolute top-2 right-2 z-20 inline-flex size-6 cursor-pointer items-center justify-center rounded-full bg-white/10 text-white/70 hover:bg-white/20 hover:text-white transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
    >
...
function MarkerPopup({
  ...
  return createPortal(
    <div
      className={cn(
        "bg-gray-900/95 backdrop-blur-xl text-white relative max-w-62 rounded-2xl border border-white/10 p-4 shadow-2xl overflow-hidden",
...
function MarkerTooltip({
  ...
  return createPortal(
    <div
      className={cn(
        "bg-gray-900/95 backdrop-blur-md text-white border border-white/10 pointer-events-none rounded-xl px-3 py-2 text-sm font-medium text-balance shadow-xl",
