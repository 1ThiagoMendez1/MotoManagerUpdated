    ...
    <div className="flex items-center gap-2">
      <div className="relative">
        ...
        <Input
          ...
          className="pl-10 pr-10 bg-card/50 border-border/50 text-foreground placeholder:text-muted-foreground w-64"
        />
        {query && (
          <Button
            variant="ghost"
      ...
      <Button
        ...
        variant="outline"
        size="sm"
        className="bg-card/50 border-border/50 text-foreground hover:bg-card/80"
      >
        Buscar
      </Button>
    </div>
